...
// MALLET PLAYER SCRIPT CS 20140908_1137 //

using UnityEngine;
using System.Collections;

public class MalletPlayerScriptCS : MonoBehaviour {
	...
	{	
		...
		else if (Input.multiTouchEnabled == false)// if "Input.multiTouchEnabled" is false, use input mouse Position
		{	
