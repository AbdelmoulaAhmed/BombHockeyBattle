...
// MALLET CPU SCRIPT CS 20140803_1200 //

using UnityEngine;
using System.Collections;

public class MalletCpuScriptCS : MonoBehaviour {
	...
	{	
	    ...
	    if (actionState == "defense")
	    {
	    	...
	    	if (puckTarget.localPosition.z > 1.3f || puckTr.rigidbody.velocity.magnitude < 2)
